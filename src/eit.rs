            ...
            while loop_len > 0 {
                ...
                // オール0xff以外の処理
                    ...
                    let dt: DateTime<Local> = Local.with_ymd_and_hms(
                        ...
                        eitb.hh as u32, eitb.hm as u32, eitb.ss as u32).unwrap();
                    // シリアル時刻の作成
                                            ...
                                            if audio_component_desc.es_multi_lingual_flag == 1 {
                                                ...
                                                if audio_component_desc.descriptor_length > 14 {
                                                    ...
                                                    (_, audio_component_desc.text_char) =
                                                        arib_to_string(&buf[index + 14..index + 14 + audio_component_desc.descriptor_length as usize - 1],
                                            ...
                                            // オーディオコンポーネントマルチランゲージフラグが1以外の処理
                                                ...
                                                if audio_component_desc.descriptor_length > 11 {
                                                    ...
                                                    (audio_component_desc.descriptor_length, audio_component_desc.text_char) =
                                                        arib_to_string(&buf[index + 11..index + 11 + audio_component_desc.descriptor_length as usize - 1],
